...
# 设置 hostname
uci set system.@system[0].hostname="tr300011"
uci commit system
...
uci set frpc.@conf[-1].remote_port='11'
# 提交更改
uci commit frpc
# 应用配置（重启 frpc 服务）
...
uci set easytier.cfg01894b.ipaddr='10.126.126.11'
uci add_list easytier.cfg01894b.proxy_network='192.168.11.0/24'
...
uci set easytier.cfg01894b.desvice_name='tr300011'
